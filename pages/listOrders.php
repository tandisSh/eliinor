            ...
            <?php if ($result->rowCount() > 0): ?> 
                <?php while ($row = $result->Fetch(PDO::FETCH_ASSOC)): ?> 
                    <div class="image-card">
                        ...
                        <div class="actions">
                            <button class="edit-btn" > <a href="edit.php?id=<?php echo $row['id']; ?>">ویرایش</a>
                            ...
                            <button class="delete-btn" ><a href="vendor/AdminDelete.php?id=<?php echo $row['id']; ?>" onclick="return confirm('آیا از حذف این محصول مطمئن هستید؟')">حذف</a>

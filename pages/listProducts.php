            ...
            <?php if ($result->rowCount() > 0): ?> 
                <?php while ($row = $result->Fetch(PDO::FETCH_ASSOC)): ?> 
                    <div class="image-card">
                        <img src="../public/images/<?php echo $row['pro_image'];  ?>" alt="Image"> <!-- اصلاح نام ستون به pro_image -->
                        <div id="details">
                        ...
                        <div class="actions">
                            <button class="edit-btn" > <a href="edit.php?id=<?php echo $row['id']; ?>" style="text-decoration:none; color:#fff;">ویرایش</a>
                            ...
                            <button class="delete-btn" ><a href="vendor/AdminDelete.php?id=<?php echo $row['id']; ?>" onclick="return confirm('آیا از حذف این محصول مطمئن هستید؟')" style="text-decoration:none; color:#fff;">حذف</a>

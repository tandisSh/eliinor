        ...
        <form action="vendor/process_checkout.php" method="POST">
            <table>
                ...
                <tr>
                    ...
                    <td><input type="text" style="text-align: right;" id="city" name="city"></td>
                </tr>
                <tr>
                    <td>آدرس <span style="color:red;">*</span></td>
                    <td><input type="text" style="text-align: right;" id="address" name="address"></td>
                </tr>
                <tr>
                    <td>کد پستی<span style="color:red;">*</span></td>
                    <td><input type="text" style="text-align: left;" id="postal_code" name="postal_code"></td>
                </tr>
                <tr>
